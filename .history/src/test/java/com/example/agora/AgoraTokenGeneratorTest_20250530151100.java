...
public class AgoraTokenGeneratorTest {
    ...
    private final AgoraTokenGenerator tokenGenerator = new AgoraTokenGenerator(appId, appCertificate);
    ...
    public void testGenerateTokenWithUid() {
        ...
        // Generate token
        String token = tokenGenerator.generateToken(channelName, uid, role, expireSeconds);
    ...
    public void testGenerateTokenWithUserAccount() {
        ...
        // Generate token
        String token = tokenGenerator.generateTokenWithUserAccount(channelName, userAccount, role, expireSeconds);
